...
<html>
  ...
  <body>
    ...
    <blockquote>
      ...
      <tr>
        <td>\${'Utility'} wo\${'rld'}</td>
        <td>String</td>
        <td><jsp:setProperty name="values" property="stringValue" value="${'Utility'} wo${'rld'}"/>${values.stringValue}</td>
      </tr>
      <tr>
        <td>\${'Utility'} wo\${'rld'}</td>
        <td>String</td>
        <td><my:values string="${'Utility'} wo${'rld'}"/></td>
      </tr>
      <tr>
        <td>\${1+2}.\${220}</td>
        <td>Double</td>
      ...
      <!--
       ...
       -->
      <tr>
        <td>\${undefinedFoo}Utility world\${undefinedBar}</td>
        <td>String</td>
        <td><jsp:setProperty name="values" property="stringValue" value="${undefinedFoo}Utility world${undefinedBar}"/>${values.stringValue}</td>
      </tr>
      <tr>
        <td>\${undefinedFoo}Utility world\${undefinedBar}</td>
        <td>String</td>
        <td><my:values string="${undefinedFoo}Utility world${undefinedBar}"/></td>
      </tr>
      <tr>
